...
// Blue theme ring colors (inner to outer lighter)
const RING_FARBEN = [
  ...
  ['rgba(50, 130, 210, 0.8)', 'rgba(70, 150, 230, 0.7)', 'rgba(90, 170, 250, 0.6)'],
  ['rgba(70, 150, 230, 0.8)', 'rgba(90, 170, 250, 0.7)', 'rgba(110, 190, 255, 0.6)'],
  ['rgba(45, 125, 205, 0.8)', 'rgba(65, 145, 225, 0.7)', 'rgba(85, 165, 245, 0.6)']
];
