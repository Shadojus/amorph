/**
 * CHEMIE - Compare-Morph für chemische Perspektive
 * 
 ...
 */
export function compareChemie(items, perspektive, config = {}) {
  debug.morphs('compareChemie', { items: items.length });
  ...
  header.innerHTML = `
    ...
    <span class="perspektive-name">${perspektive.name || 'Chemie'}</span>
